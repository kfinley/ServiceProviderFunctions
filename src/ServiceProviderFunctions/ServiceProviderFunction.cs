...
namespace ServiceProviderFunctions {
  //
  ...
  //  };
  //
  public abstract class ServiceProviderFunction {
    protected ServiceProviderFunction() {
      ServiceProviderFunction.lazyServiceProvider = new Lazy<IServiceProvider>(BuildServiceProvider);
    }
